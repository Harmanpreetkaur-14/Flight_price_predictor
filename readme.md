...
# 🛠️ Tech Stack
LayerTechnologyMachine LearningScikit-learn, Random Forest RegressorData ProcessingPandas, NumPyBackend APIFlask, REST APIDatabaseSQLAlchemy, SQLiteFrontendHTML, CSS, JavaScriptDeploymentGunicorn, Render, GitHub
# 📊 Model Performance
...
Predict flight prices instantly based on user inputs
Stores every prediction in a database with timestamp
View last 10 predictions history
Booking advice based on days left to departure
